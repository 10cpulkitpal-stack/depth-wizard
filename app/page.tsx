      ...
      <main>
        <section className="relative border-b border-white/15 px-6 py-24 sm:py-32 lg:px-12 lg:py-40">
          <div className="mx-auto max-w-[1400px] text-center">
            <p className="mb-8 font-mono text-[10px] uppercase tracking-[0.3em] text-cyan-300/70">01 / Optical imagery → spatial understanding</p>
            <h1 className="mx-auto max-w-6xl text-balance text-[clamp(3.8rem,10vw,9.5rem)] font-semibold leading-[0.84] tracking-[-0.09em]">Turn imagery<br /><span className="bg-gradient-to-b from-[#f5f5f0] via-white/85 to-cyan-200/60 bg-clip-text text-transparent">into a 3D world.</span></h1>
            <p className="mx-auto mt-10 max-w-lg text-sm leading-7 text-[#a7a7a0] sm:text-base">Estimate depth. Reconstruct terrain. Explore the result in 3D.</p>
